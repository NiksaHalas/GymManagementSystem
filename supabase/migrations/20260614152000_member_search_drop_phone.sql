-- Remove phone-number matching from member search.
-- Member-number numeric search is kept; phone stays displayed but is no longer searchable.

-- phone trigram index is no longer used by search
drop index if exists member_phone_trgm_idx;
