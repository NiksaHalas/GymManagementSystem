-- Remove ambiguous 5-arg overload (match_phone) so RPC calls with 4 args resolve cleanly.

drop function if exists public.search_members(text, boolean, integer, integer, boolean);
