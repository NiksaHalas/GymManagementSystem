-- Phase 3 rollback (DB): remove offline idempotency p_id from RPCs.
-- Reverts signature/body changes from 20260625120000; no table or data changes.

drop function if exists create_checkin(uuid, int, boolean, bigint, uuid, boolean, boolean, date, boolean, uuid);
...
drop function if exists record_payment(uuid, bigint, int, boolean, text, membership_start_mode, uuid[], uuid, date, uuid);
