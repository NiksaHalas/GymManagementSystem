...
const schema = z.object({
  username: z
    ...
    .regex(/^[a-z0-9._-]+$/, "Samo mala slova, cifre, tačka, crtica, donja crta."),
...
export function CreateAccountDialog() {
  ...
  const form = useForm<FormValues>({
    ...
    defaultValues: { username: "", password: "", role: "user", recovery_email: "" },
  });
        ...
        <Form {...form}>
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel>Email za oporavak (opciono)</FormLabel>
                  <FormControl>
                    <Input
                      type="email"
